...
data_read_path = "../../Data/TestData2.csv"
dataframe = pandas.read_csv(data_read_path)
outputs = dataframe[["Output"]]
dataframe = dataframe[["InputA","InputB"]]
iterations = 100000
...
print(network)
print(network.evaluate([1,1])) #should be 5
print(network.evaluate([2,4])) #should be 16
print(network.evaluate([3,2]))	#should be 12
print(network.evaluate([4,5]))	#should be 32
print(network.evaluate([10,10])) #should be 30